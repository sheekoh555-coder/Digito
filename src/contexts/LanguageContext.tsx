...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'seller.productSubmitted': 'File uploaded and product submitted successfully!',
    ...
    'seller.uploadErrorRLS': 'Permission error during file upload. Please check RLS settings.',
    'seller.insertErrorRLS': 'Permission error saving product data. Please check RLS settings.',
    'seller.uploadFailed': 'File upload failed:',
    'seller.insertFailed': 'Failed to save product:',
    'seller.genericError': 'An unexpected error occurred while submitting the product.',
  ...
  ar: {
    ...
    'seller.productSubmitted': 'تم رفع الملف وتقديم المنتج بنجاح!',
    ...
    'seller.uploadErrorRLS': 'حدث خطأ في الصلاحيات أثناء رفع الملف. يرجى التأكد من إعدادات الأمان (RLS).',
    'seller.insertErrorRLS': 'حدث خطأ في الصلاحيات أثناء حفظ بيانات المنتج. يرجى التأكد من إعدادات الأمان (RLS).',
    'seller.uploadFailed': 'فشل رفع الملف:',
    'seller.insertFailed': 'فشل حفظ المنتج:',
    'seller.genericError': 'حدث خطأ غير متوقع أثناء تقديم المنتج.',
