...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'seller.editPrice': 'Edit Price',
    'seller.delete': 'Delete',
    'seller.confirmDelete': 'Are you sure you want to delete this product?',
    'seller.priceUpdated': 'Price updated successfully!',
    'seller.productDeleted': 'Product deleted successfully!',
    'seller.status': 'Status',
    'seller.actions': 'Actions',
    'seller.withdrawals': 'Withdrawals',
    'success.verifying': 'Verifying your payment...',
    'success.dontClose': "Please don't close this window.",
    'success.failed': 'Payment Verification Failed',
    'success.failedDesc': "We couldn't verify your payment. If you were charged, please contact support.",
    'success.returnHome': 'Return to Home',
    'success.title': 'Payment Successful!',
    'success.desc': 'Thank you for your purchase. Your order has been confirmed and your digital product is ready.',
    'success.download': 'Download Now',
    'success.continue': 'Continue Shopping',
    'cancel.title': 'Payment Cancelled',
    'cancel.desc': 'Your payment was cancelled. No charges were made to your account.',
    'cancel.returnHome': 'Return to Home',
    'nav.settings': 'Settings',
    'settings.title': 'Settings',
    'settings.desc': 'Manage your account settings and profile.',
  ...
  ar: {
    ...
    'seller.activeProducts': 'عدد المنتجات النشطة',
    'seller.editPrice': 'تعديل السعر',
    'seller.delete': 'حذف',
    'seller.confirmDelete': 'هل أنت متأكد أنك تريد حذف هذا المنتج؟',
    'seller.priceUpdated': 'تم تحديث السعر بنجاح!',
    'seller.productDeleted': 'تم حذف المنتج بنجاح!',
    'seller.status': 'الحالة',
    'seller.actions': 'الإجراءات',
    'seller.withdrawals': 'السحوبات',
    'success.verifying': 'جاري التحقق من الدفع...',
    'success.dontClose': "يرجى عدم إغلاق هذه النافذة.",
    'success.failed': 'فشل التحقق من الدفع',
    'success.failedDesc': "لم نتمكن من التحقق من الدفع. إذا تم خصم المبلغ، يرجى الاتصال بالدعم.",
    'success.returnHome': 'العودة إلى الرئيسية',
    'success.title': 'تم الدفع بنجاح!',
    'success.desc': 'شكراً لشرائك. تم تأكيد طلبك ومنتجك الرقمي جاهز.',
    'success.download': 'تنزيل الآن',
    'success.continue': 'مواصلة التسوق',
    'cancel.title': 'تم إلغاء الدفع',
    'cancel.desc': 'تم إلغاء الدفع. لم يتم خصم أي مبالغ من حسابك.',
    'cancel.returnHome': 'العودة إلى الرئيسية',
    'nav.settings': 'الإعدادات',
    'settings.title': 'الإعدادات',
    'settings.desc': 'إدارة إعدادات حسابك وملفك الشخصي.',
