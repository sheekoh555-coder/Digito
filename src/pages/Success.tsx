...
export default function Success() {
  ...
  if (status === 'loading') {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center">
        ...
        <h2 className="text-2xl font-semibold text-neutral-900">Verifying your payment...</h2>
        <p className="text-neutral-500 mt-2">Please don't close this window.</p>
      </div>
    );
  }
  ...
  if (status === 'error') {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4">
        ...
        <h2 className="text-3xl font-semibold text-neutral-900 mb-4">Payment Verification Failed</h2>
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4">
      ...
      <h2 className="text-4xl font-semibold tracking-tight text-neutral-900 mb-4">Payment Successful!</h2>
      ...
      <div className="flex flex-col sm:flex-row gap-4 w-full max-w-sm">
        <button className="flex-1 bg-neutral-900 text-white px-6 py-3 rounded-xl font-medium hover:bg-neutral-800 transition-colors flex items-center justify-center gap-2">
